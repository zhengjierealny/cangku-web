<template>
    <div>
        ...
        >
            ...
            <el-table-column prop="totalcap" label="总容量">
            </el-table-column>
            <el-table-column prop="currentcap" label="当前存放量">
            </el-table-column>
    ...
    export default {
        ...
        data() {
            let checkDuplicate =(rule,value,callback)=>{
                ...
                this.$axios.get(this.$httpUrl+"/storage/findByNo?name="+this.form.name).then(res=>res.data).then(res=>{
                    if(res.code!=200){

                        callback()
                    }else{
                        callback(new Error('该仓库已经存在'));
                    }
                })
            };
            return {
        ...
        methods:{
            ...
            mod(row){
                ...
                this.$nextTick(()=>{
                    ...
                    this.form.totalcap = row.totalcap
                    this.form.currentcap = row.currentcap
                })
            },
            add(){
            ...
            loadPost(){
                this.$axios.post(this.$httpUrl+'/storage/listPageS',{
