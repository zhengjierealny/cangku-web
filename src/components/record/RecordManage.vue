...
<!--            </el-table-column>-->
            ...
            <el-table-column prop="count" label="出入库" width="160">
                <template slot-scope="scope">
                    <el-tag
                            :type="scope.row.count > 0 ? 'primary' :  'success'"
                            disable-transitions>{{scope.row.count> 0 ? '入库' :
                         '出库'}}</el-tag>
                </template>
            </el-table-column>
            <el-table-column prop="count" label="数量(-100出库/100入库)" width="160">
            </el-table-column>
            <el-table-column prop="createtime" label="记录生成时间" width="160">
            </el-table-column>
            ...
            <el-table-column prop="operate" label="操作" v-if="user.roleId==0">
                <template slot-scope="scope">
                    ...
                    >
                        <el-button slot="reference" size="small" type="primary" v-if="user.roleId==0">撤回</el-button>
                    </el-popconfirm>
                </template>
            </el-table-column>
        </el-table>
...
<script>
    export default {
        ...
        methods:{
            ...
            loadPost(){
                this.$axios.post(this.$httpUrl+'/record/listPageS',{
